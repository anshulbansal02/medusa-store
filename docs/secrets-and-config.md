...
- `/ecom/shared/operator/cloudflare/r2/production_media_bucket_name`
- `/ecom/shared/operator/cloudflare/r2/qa_media_bucket_name`
- `/ecom/shared/operator/domain/production_apex`
- `/ecom/shared/operator/domain/production_storefront`
- `/ecom/shared/operator/domain/production_media`
- `/ecom/shared/operator/domain/qa_storefront`
- `/ecom/shared/operator/domain/qa_medusa_api`
- `/ecom/shared/operator/domain/qa_medusa_admin`
- `/ecom/shared/operator/domain/qa_media`
- `/ecom/shared/operator/domain/transactional_email`
- `/ecom/shared/operator/github/owner`
- `/ecom/shared/operator/github/repo`
- `/ecom/shared/operator/lightsail/qa_medusa_static_ip`
- `/ecom/shared/operator/vercel/api_token`
- `/ecom/shared/operator/vercel/storefront_qa_project_name`
- `/ecom/shared/operator/vercel/storefront_prod_project_name`
- `/ecom/shared/operator/vercel/storefront_qa_medusa_publishable_key`
- `/ecom/shared/operator/better_stack/uptime_api_token`
