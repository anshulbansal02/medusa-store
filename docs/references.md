...
- GoatCounter GitHub/self-hosting: https://github.com/arp242/goatcounter
- Umami docs: https://docs.umami.is/docs
- Plausible self-hosted comparison: https://plausible.io/self-hosted-web-analytics
- Matomo on-premise docs: https://matomo.org/guide/installation-maintenance/matomo-on-premise-self-hosted/
