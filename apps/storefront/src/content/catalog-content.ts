export const catalogContent = {
  ...
  product: {
    ...
    deliveryText: "Prepaid delivery across India with dispatch updates.",
    returnsTitle: "Returns",
    returnsText: "Eligible pieces can be returned or exchanged as per policy.",
    paymentTitle: "Secure prepaid checkout",
    paymentText: "Razorpay payment appears after address and delivery details.",
